/*
 * Ported from tigerowo/infinite-canvas
 * Original source: web/src/app/(user)/canvas/utils/canvas-camera.ts
 * License: GNU AGPL-3.0
 * Adaptation: import CameraControlOptions from basket canvas types.
 */

import type { CameraControlOptions } from "@/types/canvas";
